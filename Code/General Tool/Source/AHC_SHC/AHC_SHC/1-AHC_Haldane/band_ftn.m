...
p3 = [linspace(0.5,1/3,nk+1)' linspace(0.0,-1/3,nk+1)' linspace(0.0,n,nk+1)'];
p4 = [linspace(1/3,0.0,nk+1)' linspace(-1/3,0.0,nk+1)' linspace(0.0,n,nk+1)'];
list    = [1 101 201 300 ];
...
if isSP==1
    ...
    for ii=1:norb
        plot(1:nks,Ek(:,ii)-Ef,'k-','LineWidth',2);
        hold on
    end
end
...
ax.XTick      = list(:);
ax.YTick      = E_range(1):2:E_range(2);
